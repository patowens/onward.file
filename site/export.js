...
`;
  function documentHTML(payload) {
    ...
    return '<!doctype html><html lang="en"><head><meta charset="utf-8"><!--' + SOFTWARE_LICENSE + '--><meta http-equiv="Content-Security-Policy" content="' + csp + '"><meta name="referrer" content="no-referrer"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Onward</title><style nonce="' + nonce + '">' + styles + '</style></head>' +
